  ...
  color: white;
    ...
    <div class="ex1" style="margin-top:130px;margin-bottom:80px;color:#34495E;">
		<img src="images/3.jpg" alt="Trulli" width="300" height="210">
             <center>
              <h1>Trainer Login</h1>
              <form class="form-group" method="POST" action="trainer_verify.php">
                <div class="row">
                  <div class="col-md-4"><label>Trainer ID: </label></div>
                  <div class="col-md-8"><input type="text" name="trainer_id" class="form-control" placeholder="enter number" required/></div><br>
                </div>
