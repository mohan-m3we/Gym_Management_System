  ...
  color: white;
    ...
    <div class="ex1" style="margin-top:130px;margin-bottom:80px;color:#34495E;">
		<img src="images/3.jpg" alt="Trulli" width="300" height="210">
             <center>
              <h1>Admin Login</h1>
              <form class="form-group" method="POST" action="admin_verify.php">
                <div class="row">
                  <div class="col-md-4"><label>Username: </label></div>
                  <div class="col-md-8"><input type="text" name="username" class="form-control" placeholder="enter username" required/></div><br>
                  <div class="col-md-1"><label>Password: </label></div>
                  <div class="col-md-8"><input type="password" class="form-control" name="password" placeholder="enter password" required/></div><br><br>
                </div>
