  ...
  color: white;
	...
	<hr>
		    ...
		    <div class="ex1">
                ...
                <form class="form-group" action="update_trainer.php" method="post">
                <label>Trainer ID</label><br>
				<input type="text" name="id"><br><br>
				<label>Enter Detail to be updated</label><br>
				<select name="option" size='5'>
				<option value="trainer_name">Name</option>
				<option value="trainer_dob">Date of birth</option>
				<option value="trainer_phone_no">Phone No</option>
				<option value="trainer_email">Email ID</option>
				<option value="trainer_address">Address</option>
				</select>
